...
(function( root, window, document, factory, undefined) {
	...
	var scrollelements = document.getElementsByClassName("scrolldown");
    ...
    function initialise(containerSelector, options) {
        ...
        */
        function scrollPage(element, callback, isMovementUp){
			...
			// My own stuff for when it scrolls
		
     
			
		}
			
		function togglescrollelements(a) {
...
var c = Math.sqrt(Math.pow(h,2) - (h*w) + (Math.pow(w,2)/2));
var y = h/w;*/
...
/* Open */
function openNav() {
    document.getElementById("myNav").style.transform = "scale(5)";
	document.getElementById("myNav").style.transition = "1s";
	document.getElementById("xbutton").style.transform = "scale(1)";
	document.getElementById("menubutton").style.transform = "scale(0)";
	document.getElementById("xbutton").style.opacity = "1";
...
function closeNav() {
	...
	document.getElementById("myNav").style.transition = "0.3s";
	document.getElementById("xbutton").style.transform = "scale(0)";
	document.getElementById("menubutton").style.transform = "scale(1)";
	document.getElementById("xbutton").style.opacity = "0";
